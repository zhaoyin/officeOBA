...
namespace Crownwood.DotNetMagic.Docking
{
		...
		protected override void OnPaint(PaintEventArgs e)
        {
							 ...
							 inactiveTextBrush = new SolidBrush(DockingManager.InactiveTextColor))
			{
				...
				else
				{
                    ...
                    {
                        startColor = ColorCustomize.WdcInactiveStartColor;
                        endColor = ColorCustomize.WdcInactiveEndColor;                    
                    }
				}
                ...
                Color borderColor = SystemPens.ControlDark.Color;
                if(this.DockingManager.Customize)
                    borderColor = ColorCustomize.BorderColor;
    ...
    internal class IDE2005Button : ButtonWithStyle
    {
		...
		protected override void OnPaintBackground(PaintEventArgs pevent)
		{
			...
			{
                if (!_caption.DockingManager.Customize)
                {
                ...
                {
                    caption1 = ColorCustomize.WdcInactiveStartColor;
                    caption2 = ColorCustomize.WdcInactiveEndColor;
                }
			}
			float angle = 90f;
