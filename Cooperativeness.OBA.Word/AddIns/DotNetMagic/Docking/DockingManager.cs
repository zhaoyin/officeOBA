...
namespace Crownwood.DotNetMagic.Docking
{
	...
	public class DockingManager : IDisposable
	{
        ...
        /// <remarks>
        /// try...catch..., do nothing, by Edgard Tsou(周晓兵)
        /// 防止U871第U8dp200145191好问题，详见CQ
        /// </remarks>
		...
		internal void OnShowContextMenu(Point screenPos)
		{
            ...
            // modified byEdgard Zhou, Show All和Hide All功能会引发门户BUG，所以注销下面两句
            //
