...
namespace Crownwood.DotNetMagic.Controls
{
	...
	public class TabGroupLeaf : TabGroupBase
	{
        ...
        private MenuCommand _mcCloseAll; //关闭所有页签
        private MenuCommand _mcCloseOther; //关闭其他页签
        ...
        private static ImageList _inertalImages2;
        ...
        static TabGroupLeaf()
        {
            ...
            // Create a strip of images by loading an embedded bitmap resource
            _inertalImages2 = ResourceHelper.LoadBitmapStrip(Type.GetType("Crownwood.DotNetMagic.Controls.TabbedGroups"),
                                                             "Crownwood.DotNetMagic.Resources.ImagesMenuControl.bmp",
                                                             new Size(IMAGE_WIDTH, IMAGE_WIDTH),
                                                             new Point(0, 0));
		...
		{
            _mcCloseAll.Click -= new EventHandler(this.TabbedGroups.OnCloseAll);
            _mcCloseOther.Click -= new EventHandler(this.TabbedGroups.OnCloseOther);
        ...
        internal void OnClose(object sender, EventArgs e)
        {
            ...
            if ((_tabControl.TabPages.Count > 0) || _tabbedGroups.PageCloseWhenEmpty)
            {
				...
				if (!tge.Cancel && (_tabControl.TabPages.Count > 0))
				{
                    ...
                    _tabbedGroups.OnPageClosed(tge);
				}
            }
        }
		...
		private void DefinePopupMenuForControl(Controls.TabControl tabControl)
		{
            ...
            _mcCloseOther = new MenuCommand("",new EventHandler(this.TabbedGroups.OnCloseOther));
            _mcCloseAll = new MenuCommand("", new EventHandler(this.TabbedGroups.OnCloseAll));
			// Add all the standard menus we manage
            _mcClose = new MenuCommand("",new EventHandler(OnClose));
            _mcClose.Image = _inertalImages2.Images[(int)ImageStrip.Close];
        ...
        private void OnPopupMenuDisplay(object sender, CancelEventArgs e)
        {
            ...
            {        
                ...
                _mcCloseOther.Text = _tabbedGroups.CloseOtherMenuText;
                _mcCloseAll.Text = _tabbedGroups.CloseAllMenuText;
                ...
                _mcClose.Visible = valid;
                _mcSep1.Visible = valid;
                _mcCloseAll.Visible = valid;
                _mcCloseOther.Visible = valid;
