...
namespace Cooperativeness.OBA.Word.Convertor
{
    ...
    /// 定义Html转换器
    /// </summary>
    internal class HtmlConverter : AbstractConverter
    {
        /// <summary>
        /// 转换处理
        /// </summary>
        ...
        protected override string OnConvert(string fileName, string outputDir)
        {
            ...
            try
            {
                ...
                // 创建Word应用程序对象
                wordApp = new OfficeWord.Application();
                // 设置可见性
                wordApp.Visible = false;
                // 保存文件路径
                string saveHtmlPath = Path.Combine(outputDir, Path.GetFileNameWithoutExtension(fileName) + ".htm");
                object saveTarget = saveHtmlPath;
                // 打开文件
                ...
                // 设置格式
                object saveFormat = OfficeWord.WdSaveFormat.wdFormatHTML;
                // 另存为HTML格式文件
        ...
        {
            return fileName.IsWordDocument();
        }
    }
}
