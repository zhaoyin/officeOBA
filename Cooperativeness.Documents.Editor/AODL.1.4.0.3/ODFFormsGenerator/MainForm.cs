	...
	public class mainForm : System.Windows.Forms.Form
	{
		...
		private void menuItem3_Click(object sender, System.EventArgs e)
		{
			if (openFileDialog1.ShowDialog() == DialogResult.OK)
			{
                ...
                {
                    textDocument.Load(openFileDialog1.FileName, new OpenDocumentImporter(reader));
                }
			...
			else
			{
				...
				if (gender != null)
				{
					...
					if (eGender.SelectedIndex == 0)
					{
						if (m != null && f !=null)
						{
							m.CurrentSelected = true;
							f.CurrentSelected = false;
						}
					}
					else if (eGender.SelectedIndex == 1)
					{
						if (f != null && m !=null)
						{
							f.CurrentSelected = true;
							m.CurrentSelected = false;
						}
					}
				}
                ...
                using (IPackageWriter writer = new OnDiskPackageWriter())
                {
                    textDocument.Save(lastOpenedFile, new OpenDocumentTextExporter(writer));
                }
			}
		}
