...
namespace AODL.Document.Import.PlainText
{
	...
	public class CsvImporter : IImporter, IPublisherInfo
	{
		...
		public CsvImporter()
		{
			this._importError					= new List<AODLWarning>();
		...
		public void Import(IDocument document, string filename)
		{
			...
			IList<string> lines			= this.GetFileContent(filename);
        ...
        private IList<AODLWarning> _importError;
		/// <summary>
		...
		private void CreateTables(IList<string> lines)
		{
		...
		/// <returns>All text lines as an List of strings.</returns>
		private IList<string> GetFileContent(string fileName)
		{
