...
namespace AODL.Document.TextDocuments
{
	...
	public class TextDocumentHelper
	{
		...
		{
		    const string header = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?> <office:document-content"
		...
		/// </summary>
		/// <param name="nametable">The XmlNameTable of the TextDocument object XDocument.</param>
