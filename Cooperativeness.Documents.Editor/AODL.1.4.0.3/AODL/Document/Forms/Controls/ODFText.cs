...
namespace AODL.Document.Forms.Controls
{
    ...
    public class ODFText : ODFFormControl
    {
        ...
        public ODFText(ODFForm parentForm, ContentCollection contentCollection, string id)
        ...
        public ODFText(ODFForm parentForm, ContentCollection contentCollection, string id, string x, string y,
                       string width, string height) : base(parentForm, contentCollection, id, x, y, width, height)
        {
        }

        public ODFText(ODFForm parentForm, XElement node) : base(parentForm, node)
        {
        }
        ...
        public int? MaxLength
        {
            ...
            set { Node.SetAttributeValue(Ns.Form + "max-length", (value.HasValue && value.Value > 0) ? value : null); }
        }
        ...
        {
            XElement xe = new XElement(Ns.Form + "text");
            Node.Add(xe);
            Node = xe;
        }
    }
