...
namespace AODL.Document.Forms.Controls
{
    ...
    public class ODFDate : ODFFormControl
    {
        ...
        public ODFDate(ODFForm parentForm, ContentCollection contentCollection, string id)
        ...
        public ODFDate(ODFForm parentForm, ContentCollection contentCollection, string id, string x, string y,
                       string width, string height) : base(parentForm, contentCollection, id, x, y, width, height)
        {
        }

        public ODFDate(ODFForm parentForm, XElement node) : base(parentForm, node)
        {
        }
        ...
        {
            XElement xe = new XElement(Ns.Form + "date");
            Node.Add(xe);
            Node = xe;
        }
    }
