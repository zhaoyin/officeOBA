...
namespace AODL.Document.Forms.Controls
{
    public class ODFCheckBox : ODFFormControl
    {
        ...
        public ODFCheckBox(ODFForm parentForm, ContentCollection contentCollection, string id)
        ...
        public ODFCheckBox(ODFForm parentForm, ContentCollection contentCollection, string id, string x, string y,
                           string width, string height) : base(parentForm, contentCollection, id, x, y, width, height)
        {
        }

        public ODFCheckBox(ODFForm parentForm, XElement node) : base(parentForm, node)
        {
        }
        ...
        {
            get { return (bool?) Node.Attribute(Ns.Form + "is-tristate"); }
            set { Node.SetAttributeValue(Ns.Form + "is-tristate", value); }
        }
        ...
        public State? State
        {
            get
            {
                string s = (string) Node.Attribute(Ns.Form + "state");
                if (s == null) return null;

                switch (s)
                {
                    case "unchecked":
                        return Forms.State.Unchecked;
                    case "checked":
                        return Forms.State.Checked;
                    case "unknown":
                        return Forms.State.Unknown;
                    default:
                        return null;
                }
            }
            set
            {
                ...
                switch (value)
                {
                    case Forms.State.Unchecked:
                        s = "unchecked";
                        break;
                    case Forms.State.Checked:
                        s = "checked";
                        break;
                    case Forms.State.Unknown:
                        s = "unknown";
                        break;
                    default:
                        s = null;
                ...
                Node.SetAttributeValue(Ns.Form + "state", s);
            }
        }
        ...
        public State? CurrentState
        {
            get
            {
                string s = (string) Node.Attribute(Ns.Form + "current-state");
                if (s == null) return null;
            ...
            set
            {
                ...
                Node.SetAttributeValue(Ns.Form + "current-state", s);
            }
        }

        protected override void CreateBasicNode()
        {
            XElement xe = new XElement(Ns.Form + "checkbox");
            Node.Add(xe);
            Node = xe;
