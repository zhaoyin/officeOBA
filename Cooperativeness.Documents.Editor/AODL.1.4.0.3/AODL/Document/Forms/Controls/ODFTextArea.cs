...
namespace AODL.Document.Forms.Controls
{
    public class ODFTextArea : ODFFormControl
    {
        ...
        public ODFTextArea(ODFForm parentForm, ContentCollection contentCollection, string id)
        ...
        public ODFTextArea(ODFForm parentForm, ContentCollection contentCollection, string id, string x, string y,
                           string width, string height) : base(parentForm, contentCollection, id, x, y, width, height)
        {
        }

        public ODFTextArea(ODFForm parentForm, XElement node) : base(parentForm, node)
        {
        }
        ...
        {
            XElement xe = new XElement(Ns.Form + "textarea");
            Node.Add(xe);
            Node = xe;
