...
namespace AODL.Document.Forms.Controls
{
    public class ODFFrame : ODFFormControl
    {
        ...
        public ODFFrame(ODFForm parentForm, ContentCollection contentCollection, string id)
        ...
        public ODFFrame(ODFForm parentForm, ContentCollection contentCollection, string id, string x, string y,
                        string width, string height) : base(parentForm, contentCollection, id, x, y, width, height)
        {
        }

        public ODFFrame(ODFForm parentForm, XElement node) : base(parentForm, node)
        {
        }
        ...
        {
            XElement xe = new XElement(Ns.Form + "frame");
            Node.Add(xe);
            Node = xe;
