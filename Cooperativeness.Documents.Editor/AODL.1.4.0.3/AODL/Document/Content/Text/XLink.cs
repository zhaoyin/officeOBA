...
namespace AODL.Document.Content.Text
{
    ...
    public class XLink : IText, IHtml, ITextContainer, ICloneable
    {
        ...
        {
            get { return (string) Node.Attribute(Ns.Office + "name"); }
            set { Node.SetAttributeValue(Ns.Office + "name", value); }
        }
        ...
        {
            get { return (string) Node.Attribute(Ns.Office + "target-frame-name"); }
            set { Node.SetAttributeValue(Ns.Office + "target-frame-name", value); }
        }
