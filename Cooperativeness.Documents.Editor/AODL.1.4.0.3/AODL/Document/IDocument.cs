...
namespace AODL.Document
{
	...
	{
		/// <summary>
		/// Every document must have a XDocument that
		...
		/// The font list
		/// </summary>
		IList<string> FontList {get; set;}
		/// <summary>
		/// Graphics used within the document.
		/// </summary>
		IList<Graphic> Graphics {get;}
		/// <summary>
		/// EmbedObject used within the document.
		/// </summary>
		IList<EmbedObject> EmbedObjects {get;}
        ...
        /// </summary>
        CustomFileCollection CustomFiles { get; }
		/// <summary>
		...
		void Load(string file, IImporter importer);
		/// <summary>
		/// Save the document by using the passed IExporter
		/// with the passed file name.
		/// </summary>
		/// <param name="file">The name of the new file.</param>
		/// <param name="exporter"></param>
		void Save(string file, Export.IExporter exporter);
	}
