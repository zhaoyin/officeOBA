...
namespace Cooperativeness.Documents.Editor.Converter
{
    ...
    /// Lenfers</see>
    /// </remarks>
    public class DocRuler : FrameworkElement
    {
        #region Fields
        ...
        public static readonly DependencyProperty ZoomProperty =
            DependencyProperty.Register("Zoom", typeof(double), typeof(DocRuler),
        ...
        public static readonly DependencyProperty ChipProperty =
             DependencyProperty.Register("Chip", typeof(double), typeof(DocRuler),
        ...
        public static readonly DependencyProperty CountShiftProperty =
             DependencyProperty.Register("CountShift", typeof(int), typeof(DocRuler),
        ...
        public static readonly DependencyProperty MarksProperty =
             DependencyProperty.Register("Marks", typeof(MarksLocation), typeof(DocRuler),
        ...
        static DocRuler()
        {
            HeightProperty.OverrideMetadata(typeof(DocRuler), new FrameworkPropertyMetadata(20.0));
        }
        public DocRuler()
        {
